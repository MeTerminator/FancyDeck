...
const desk: LayoutPreset = {
  ...
  rows: 3,
  slots: [
    slot('datetime:date', 1, 1),
    slot('datetime:time', 2, 1, 2, 2),
    slot('datetime:almanac', 4, 1),
    slot('weather:current', 1, 2),
    slot('home:devices', 4, 2, 1, 2),
    slot('agenda:next', 1, 3),
    slot('media:full', 2, 3, 2, 1),
  ],
...
const portrait: LayoutPreset = {
  ...
  slots: [
    slot('datetime:date', 1, 1),
    slot('datetime:almanac', 2, 1),
    slot('datetime:time', 1, 2, 2, 2),
    slot('weather:current', 1, 4),
    slot('agenda:next', 2, 4),
    slot('media:full', 1, 5, 2, 1),
    slot('home:devices', 1, 6, 2, 1),
  ],
...
const agendaSoon: LayoutPreset = {
  ...
  slots: [
    ...
    slot('weather:current', 1, 3),
    slot('datetime:date', 2, 3),
    slot('media:controls', 3, 3, 2, 1),
  ],
  orientation: 'landscape',
